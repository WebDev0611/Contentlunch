    ...
    <div class="calendar-container">
        ...
        <div class="calendar-menu">
            <div class="calendar-menu-navigator">
                <a href="/weekly/{{$cal->id}}/{{$prev_day_string}}" class="calendar-menu-navigator-link pull-left">
                    <i class="icon-arrow-right icon-flip-horizontal"></i>
                </a>
                <span class="calendar-menu-navigator-date">{{$weekly_display_string}}</span>
                <a href="/weekly/{{$cal->id}}/{{$next_day_string}}" class="calendar-menu-navigator-link pull-right">
            ...
            <div class="calendar-menu-select">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    @foreach($my as $myCalendar)
                        <li>
                            <a href="{{route('calendarWeekly', $myCalendar->id)}}">{{$myCalendar->name}}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
