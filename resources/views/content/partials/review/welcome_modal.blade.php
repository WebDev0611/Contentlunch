    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="inner text-center">
          ...
          <p class="medium">Greetings. You are about to review <strong>{{ $content->title }}</strong> document shared with you by <strong>AUTHOR</strong>. Let us give you a quick user interface tour before you begin your review.</p>
        </div>
      </div>
