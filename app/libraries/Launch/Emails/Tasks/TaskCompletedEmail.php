...
class TaskCompletedEmail extends AbstractTaskNotificationEmail {
	...
	public function send($subscriberId)
	{
		...
		$this->mailData['template'] = 'emails.tasks.taskcompleted';
		$this->mailData['subject'] = "{$this->someoneHasText} marked '{$this->currentTask['name']}' on the {$this->taskParentTitle} {$this->taskParentType} as complete";
		$this->doSend();
	}
}