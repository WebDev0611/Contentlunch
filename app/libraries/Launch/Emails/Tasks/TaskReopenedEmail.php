...
class TaskReopenedEmail extends AbstractTaskNotificationEmail {
	...
	public function send($subscriberId)
	{
		...
		$this->mailData['template'] = 'emails.tasks.taskreopened';
		$this->mailData['subject'] = "{$this->someoneHasText} reopened '{$this->currentTask['name']}' on the {$this->taskParentTitle} {$this->taskParentType}";
		$this->doSend();
	}
