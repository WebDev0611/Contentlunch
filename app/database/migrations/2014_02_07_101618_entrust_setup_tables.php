  ...
  public function up()
  {
    ...
    $permissions = [
      ...
      ['create_edit_content_other', 'Access other User\'s Completed Content',
        ['manager']],
      ['create_execute_ideas_own', 'Create / edit own concepts',
        ['manager', 'creator', 'editor', 'client']],
      ['create_view_ideas_other', 'Access Concepts Created by Other Users',
        ['manager', 'editor']],
      ['create_edit_ideas_other', 'Access Concepts Created by Other Users',
        ['manager']],
      // Collaborate
