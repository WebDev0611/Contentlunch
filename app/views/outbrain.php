<html>
	...
	<?php
		/*
		$url = 'google.com';
		$url = rawurlencode('themindunleashed.org/2014/07/11-ways-live-happier-life-according-psychologist-hint-nothing-money.html');
	...
	<body>
		...
		<div class="modal-body">
			...
			<b>Coming soon</b>
			<!--<div class="OB_AMPLIFY" data-url="<?php print $url; ?>" data-channel-id="64126"></div>-->
		</div>
		...
		<script type="text/javascript">
			(function() {
				...
				ob.async = true;
				ob.src = "http://widgets.outbrain.com/amplifyThis/amplify.js";
