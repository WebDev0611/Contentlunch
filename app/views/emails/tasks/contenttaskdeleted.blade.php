							...
							<table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
								...
								<tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
									<td class="content-block" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 10px 0 10px;" valign="top">
										{{ $someoneHasText }} deleted the Task <i><strong style='color: #6da5ff;'>{{{ $taskName }}}</strong></i> on the <a style="text-decoration: none;" href="{{ $contentUrl }}"><strong style="color: #990000">{{ $contentTitle }}</strong></a> content.
									</td>
								</tr>
